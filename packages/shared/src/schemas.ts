...
export const safeClawConfigSchema = z
  .object({
    version: z.string(),
...
export const openClawToolsExecSchema = z
  .object({
...
export const openClawToolsConfigSchema = z
  .object({
...
export const openClawBrowserConfigSchema = z
  .object({
...
export const openClawSandboxDockerConfigSchema = z
  .object({
...
export const openClawSandboxConfigSchema = z
  .object({
...
export const securityLayerStatusSchema = z.enum(["configured", "partial", "unconfigured", "error"]);

export const securityCheckSchema = z
  .object({
    id: z.string(),
    label: z.string(),
    passed: z.boolean(),
...
export const securityLayerSchema = z
  .object({
    id: z.string(),
    name: z.string(),
...
export const srtNetworkConfigSchema = z
  .object({
...
export const srtFilesystemConfigSchema = z
  .object({
...
export const srtSettingsSchema = z
  .object({
...
export const srtStatusSchema = z
  .object({
    installed: z.boolean(),
